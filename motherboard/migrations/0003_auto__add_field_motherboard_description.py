...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Motherboard.description'
        db.add_column('motherboard_motherboard', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Motherboard.description'
        db.delete_column('motherboard_motherboard', 'description')
